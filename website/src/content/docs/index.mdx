...
hero:
  title: ' '
  tagline: Most security tools tell you your controls are configured. Sidereal tells you they are actually working.
  image:
    file: ../../assets/sidereal-logo.svg
    alt: Sidereal
  actions:
    - text: Get Started
      ...
      icon: right-arrow
    - text: View on GitHub
      link: https://github.com/primaris-tech/sidereal
      icon: external
      variant: minimal
---
