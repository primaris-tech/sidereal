...
# Sidereal — Component Definition

## Component Metadata

| Field | Value |
|---|---|
| Component Name | Sidereal |
...
Sidereal is a Kubernetes-native security operator for continuous security control
...
To compile to OSCAL:
```
trestle assemble component-definition -n sidereal
```

To validate:
```
oscal-cli component-definition validate \
  -f component-definitions/sidereal/component-definition.json
```
...
- `not-applicable` — Control does not apply to Sidereal's context
