...
> **Note**: This is one of six pre-built deployment profiles shipped with Sidereal. See also: `kyverno-cilium-falco`, `opa-calico-tetragon`, `kyverno-eks`, `opa-aks`, `opa-rke2`. Custom profiles are supported for agency-specific configurations.

**Profile ID**: `kyverno-gke`
**Description**: Sidereal deployment profile for Google GKE clusters with Dataplane V2 (Cilium-based CNI), Kyverno admission control, and Falco runtime detection.
